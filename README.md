...
中文为主、中英对照的交互美术史导航。目前收录 123 个入口、33 件作品图、86 组关联和 8 条学习路线。

包含时代与地域地图、作品浏览、搜索筛选、主题路线、收藏及两项对照。内容覆盖史前至当代及设计、视觉媒介；这是学习导航，并非穷尽的世界美术史。
...
| `data/artworks.json` | 图片路径、图注、作者与原始出处 |
...
预期项目网址：https://bhj8.github.io/ArtHistory/ 。以 Pages 设置或部署输出中的实际地址为准（用户站点的自定义域名可能改变地址）。
